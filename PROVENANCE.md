...
The current `ibnot_cli` folder keeps the geometric core and capacity-constrained optimization logic, while removing the legacy Qt/OpenGL GUI path and replacing the SuiteSparse QR dependency with an Eigen-based sparse QR path.
